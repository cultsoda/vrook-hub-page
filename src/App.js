...
const translations = {
  jp: {
    ...
    profitTitle: "持続可能な収益性",
    profitDesc: "業界最低水準の手数料9.99%から始まり、メンバーシップ、PPV、ファンのサポート、ブランド広告マッチングなど、多角的な収益モデルを通じてパートナーのIP収益を最大化する機会を提供します。",
    profitHighlight: "手数料9.99%",
  ...
  kr: {
    ...
    profitTitle: "지속 가능한 수익성",
    profitDesc: "업계 최저 수준의 수수료 9.99% 정책을 시작으로, 멤버십, 단건결제(PPV), 팬 후원, 브랜드 광고 매칭 등 다각화된 수익 모델을 통해 파트너사의 IP 수익을 극대화할 기회를 제공합니다.",
    profitHighlight: "수수료 9.99%",
